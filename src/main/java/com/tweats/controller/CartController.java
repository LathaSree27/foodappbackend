...
public class CartController {
    ...
    public void updateQuantity(Principal principal,
                               ...
                               @RequestParam(value = "quantity") @Min(value = 0, message = "Quantity can't be negative!") long quantity) throws CartItemNotFoundException, CartAccessDeniedException, CartNotFoundException, ItemUnavailableException {
